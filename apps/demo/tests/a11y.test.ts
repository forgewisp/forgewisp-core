...
// Loads the demo's index.html body into the jsdom document so the static
...
describe('a11y — index.html attributes', () => {
  ...
  it('clear-audit button is type=button (not submit)', () => {
    const btn = document.getElementById('clear-audit-btn') as HTMLButtonElement | null;
